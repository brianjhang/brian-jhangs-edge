...
5. **🆕 多語言 Slug 格式**：必須遵循統一格式標準（2025-09-29 更新）
   - 中文文章：`slug: "ai/tools/article-name"` (主題/類目/文章名稱)
   - 英文文章：`slug: "en/ai/tools/article-name"` (語言/主題/類目/文章名稱)
   - 禁止使用舊格式：`"tools/article-name-en"` 或扁平化結構
   - 詳細規範參考：`docs/implementation/unified-slug-format.md`
